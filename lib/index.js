...
function boomJS(node, config) {
    return new Promise(function (resolve, reject) {
        ...
        var _b = config || {}, _c = _b.m, m = _c === void 0 ? width : _c, _d = _b.n, n = _d === void 0 ? height : _d, _e = _b.a, a = _e === void 0 ? 0.001 : _e, _f = _b.speed, speed = _f === void 0 ? 1 : _f, _g = _b.duration, duration = _g === void 0 ? 1000 : _g;
        // 必需的对象
        ...
        dom2img(node)
            ...
            image.onload = function () {
                ...
                // 初始速度
                var u_speed = webgl.getUniformLocation(webglProgram, "u_speed");
                webgl.uniform1f(u_speed, speed * 1.0);
                // 加速度
                var u_a = webgl.getUniformLocation(webglProgram, "u_a");
                webgl.uniform1f(u_a, a * 1.0);
                // 时间
                var time = 0.0;
                var u_time = webgl.getUniformLocation(webglProgram, "u_time");
                // 最大时间
                var maxTime = Math.min(duration, speed / a);
                // 停止渲染
                function stopRender() {
